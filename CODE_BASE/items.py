...
class Coin(Item):
    ...
    def __init__(self, pos):
        ...
        self.x = pos[0]
        self.y = pos[1]
        self.avatar = pygame.image.load('/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/coin.png')
...
class Bomb(Item):
    ...
    def __init__(self, pos, owner, timer, power, color, custom_sprite=None):
        ...
        if custom_sprite is None:
            self.avatar = pygame.image.load(f'/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/bomb_{color}.png')
        else:
...
class Explosion(Item):
    ...
    def __init__(self, blast_coords, screen_coords, owner):
        ...
        self.stages = [pygame.image.load(f'/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/explosion_{i}.png') for i in range(6)]
