...
class Agent(object):
    ...
    coin_trophy = smoothscale(pygame.image.load('/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/coin.png'), (15,15))
    suicide_trophy = smoothscale(pygame.image.load('/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/explosion_2.png'), (15,15))
    time_trophy = pygame.image.load('/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/hourglass.png')
    ...
    def __init__(self, process, pipe_to_agent, ready_flag, color, train_flag):
        ...
        try:
            ...
            self.avatar = pygame.image.load(f'/content/gdrive/My Drive/alphabomb/neuesAlphabomb/assets/robot_{self.color}.png')
        ...
        self.shade = pygame.Surface((30,30))
